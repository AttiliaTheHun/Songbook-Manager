*NOTE: The program is currently in an early-access version. The codebase should be stable, but some features are not yet complete and there is much optimization to be done.*
# Songbook Manager
