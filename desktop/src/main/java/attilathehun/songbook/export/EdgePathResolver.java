...
@TODO(description = "Replace hardcoded paths with win path variables like %ProgramFiles(x86)%")
@Deprecated
public class EdgePathResolver extends BrowserPathResolver {
    ...
    public String resolve() throws IOException {
        final String savedPath = preferences.get(EDGE_PATH_VARIABLE, null);
        if (savedPath != null) {
    ...
    private void unsave() {
        preferences.remove(EDGE_PATH_VARIABLE);
    }
