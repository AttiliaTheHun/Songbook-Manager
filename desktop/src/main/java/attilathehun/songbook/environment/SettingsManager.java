...
public final class SettingsManager {
    ...
    private static HashMap<String, Setting<?>> getDefaultSettings() {
        ...
        map.put("REMOTE_INDEX_URL", new Setting<String>("REMOTE_INDEX_URL", "http://beta-hrabozpevnik.clanweb.eu/api/index/", "", Setting.TYPE_URL_ALLOW_EMPTY, "Address of the remote index download endpoint", "Insert a full URL address"));
        map.put("REMOTE_VERSION_TIMESTAMP_URL", new Setting<String>("REMOTE_VERSION_TIMESTAMP_URL", "http://beta-hrabozpevnik.clanweb.eu/api/version-timestamp/", "", Setting.TYPE_URL_ALLOW_EMPTY, "Address of the remote version timestamp download endpoint", "Insert a full URL address"));
