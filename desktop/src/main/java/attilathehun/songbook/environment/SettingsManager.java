...
public final class SettingsManager {
    ...
    private static HashMap<String, Setting<?>> getDefaultSettings() {
        ...
        map.put("REMOTE_DATA_URL", new Setting<String>("REMOTE_DATA_URL", "http://beta-hrabozpevnik.clanweb.eu/api/data/", "", Setting.TYPE_URL_ALLOW_EMPTY, "Address of the remote download endpoint", "Insert a full URL address"));
        map.put("REMOTE_TOKENS_URL", new Setting<String>("REMOTE_TOKENS_URL", "http://beta-hrabozpevnik.clanweb.eu/api/tokens/", "", Setting.TYPE_URL_ALLOW_EMPTY, "Address of the remote tokens endpoint", "Insert a full URL address"));
        map.put("REMOTE_BACKUPS_URL", new Setting<String>("REMOTE_BACKUPS_URL", "http://beta-hrabozpevnik.clanweb.eu/api/backups/", "", Setting.TYPE_URL_ALLOW_EMPTY, "Address of the remote backups endpoint", "Insert a full URL address"));
        map.put("REMOTE_DATA_INDEX_URL", new Setting<String>("REMOTE_DATA_INDEX_URL", "http://beta-hrabozpevnik.clanweb.eu/api/index/", "", Setting.TYPE_URL_ALLOW_EMPTY, "Address of the remote index download endpoint", "Insert a full URL address"));
        map.put("REMOTE_DATA_VERSION_TIMESTAMP_URL", new Setting<String>("REMOTE_DATA_VERSION_TIMESTAMP_URL", "http://beta-hrabozpevnik.clanweb.eu/api/version-timestamp/", "", Setting.TYPE_URL_ALLOW_EMPTY, "Address of the remote version timestamp download endpoint", "Insert a full URL address"));
