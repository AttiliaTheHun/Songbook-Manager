...
public class CollectionEditorV1 extends JFrame implements KeyEventListener, CollectionListener {

    private static final Logger logger = LogManager.getLogger(CollectionEditorV1.class);

    private static boolean IS_FOCUSED = false;

    private static CollectionEditorV1 instance = null;
     ...
     */
    public static CollectionEditorV1 openCollectionEditor() {
        if (instance != null) {
     ...
     */
    public static CollectionEditorV1 getInstance() {
        return instance;
    }
