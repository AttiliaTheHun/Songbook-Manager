...
public class BrowserFactory implements SettingsListener, AutoCloseable {
    ...
    private String askTerminalForExecutableWindows() {
        ...
        final String[][] COMMANDS = new String[][] {
                ...
                {"reg", "query", "HKEY_LOCAL_MACHINE\\Software\\Microsoft\\Windows\\CurrentVersion\\", "/s", "/f", "\\chrome.exe", "|", "findstr", "Default"}, // TODO: this seems incorrect
    ...
    private String askTerminalForExecutableLinux() {
        ...
        final String[] EXECUTABLE_NAMES = new String[] { "google-chrome", "google-chrome-stable", "microsoft-edge", "microsoft-edge-stable", "chromium", "chromium-browser", "brave-browser", "brave-browser-stable" };
