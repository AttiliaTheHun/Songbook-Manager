...
public final class Environment {
    ...
    public static final String IGNORED_EXCEPTION_MESSAGE = "ignored exception"; // these exceptions are used to artificially alter the control flow and will be handled in a special way
