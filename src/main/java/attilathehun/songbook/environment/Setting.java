...
public final class Setting<T> implements Serializable {
    ...
    public static final String TYPE_STRING_DESCRIPTION = "";
    public static final String TYPE_NON_EMPTY_STRING_DESCRIPTION = "";
    public static final String TYPE_DOUBLE_DESCRIPTION = "";
    public static final String TYPE_INTEGER_DESCRIPTION = "";
    public static final String TYPE_POSITIVE_INTEGER_DESCRIPTION = "";
    public static final String TYPE_URL_DESCRIPTION = "";
    public static final String TYPE_URL_ALLOW_EMPTY_DESCRIPTION = "";
    public static final String TYPE_OTHER_DESCRIPTION = "";
