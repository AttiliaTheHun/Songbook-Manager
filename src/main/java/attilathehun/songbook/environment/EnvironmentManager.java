...
public final class EnvironmentManager {
    ...
    /**
     * The platform API method for performing data loading. Tries to load a local zip archive file. This method provides visual feedback through {@link AlertDialog}s and so is not
    ...
    /**
     * The platform API method for performing data saving. Attempts to save the data into a local zip archive file. This method provides visual feedback through {@link AlertDialog}s and so is not
     * a good pick for background work.
     */
    public void save() {
    ...
    public void createNewSongbook() {
        try {
            ...
            if (!collectionJSONFile.createNewFile()) {
                throw new RuntimeException("failed to create standard collection file");
            }
    ...
    public void loadSongbook() {
        if (!extractLocalDataFile()) {
            logger.debug("failed to load songbook");
            Platform.exit();
            return;
        }
        Environment.getInstance().registerCollectionManager(StandardCollectionManager.getInstance());
