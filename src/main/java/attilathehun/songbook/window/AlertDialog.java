...
public class AlertDialog extends Stage {
    ...
    private void createScene(final String message, final String okButtonText, final String closeButtonText, final String extraButtonText, final String icon,
        ...
        if (message != null && !message.isEmpty()) {
            ...
            if (icon != null && !icon.isEmpty()) {
                final ImageView image = new ImageView(new Image(Main.class.getResourceAsStream(icon)));
        ...
        if (!buttonBar.getChildren().isEmpty()) {
            ((Button) buttonBar.getChildren().getFirst()).setDefaultButton(true);
    ...
    public static class Builder {
        ...
        public enum Icon {
            ...
            INFO("/assets/dialog-information.png"),
            WARNING("/assets/dialog-warning.png"),
            ERROR("/assets/dialog-error.png"),
            CONFIRM("/assets/dialog-confirm.png");
