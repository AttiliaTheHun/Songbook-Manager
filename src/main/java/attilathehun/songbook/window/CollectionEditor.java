...
public final class CollectionEditor extends Stage {
    ...
    private void initBottomToolbar() {
        ...
        editSongRecordButton.setOnAction(actionEvent -> {
            ...
            final CompletableFuture<Song> result = selectedManager.editSongDialog(selectedSong);
        ...
        previewPDFButton.setOnAction(actionEvent -> {
            ...
            SwingUtilities.invokeLater(() -> {
                try {
                    ...
                    Platform.runLater(() -> new AlertDialog.Builder().setTitle("Error").setMessage(ex.getLocalizedMessage()).setParent(this).setIcon(AlertDialog.Builder.Icon.INFO).addOkButton().build().open());
                }
            });
